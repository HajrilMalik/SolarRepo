...
export function ChartPower({ readings }) {
    ...
    // Extract data for Pmax and timestamp directly from Firebase
    let readingData = filteredReadings.map((key) => {
        const reading = readings[key];

        // Ambil Pmax langsung dari Firebase data
        const Pmax = reading.Pmax || 0;  // Default ke 0 jika tidak ada data Pmax
